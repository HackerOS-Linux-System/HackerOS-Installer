...
class AppTheme {
  ...
  static ThemeData get darkTheme => ThemeData(
    ...
    appBarTheme: const AppBarTheme(
      ...
      elevation: 0,
      centerTitle: false,
      titleTextStyle: TextStyle(fontFamily: 'Sora', fontSize: 17,
                                fontWeight: FontWeight.w600, color: textPrimary),
                                iconTheme: IconThemeData(color: textPrimary),
    ),
    textTheme: const TextTheme(
      displayLarge:   TextStyle(fontFamily: 'Sora', fontSize: 44,
                                fontWeight: FontWeight.w700, color: textPrimary, letterSpacing: -1.5),
                               displayMedium:  TextStyle(fontFamily: 'Sora', fontSize: 34,
                                                         fontWeight: FontWeight.w700, color: textPrimary, letterSpacing: -1.0),
                               headlineLarge:  TextStyle(fontFamily: 'Sora', fontSize: 26,
                                                         fontWeight: FontWeight.w600, color: textPrimary),
                               headlineMedium: TextStyle(fontFamily: 'Sora', fontSize: 21,
                                                         fontWeight: FontWeight.w600, color: textPrimary),
                               titleLarge:     TextStyle(fontFamily: 'Sora', fontSize: 17,
                                                         fontWeight: FontWeight.w600, color: textPrimary),
                               titleMedium:    TextStyle(fontFamily: 'Sora', fontSize: 14,
                                                         fontWeight: FontWeight.w500, color: textPrimary),
                               bodyLarge:      TextStyle(fontFamily: 'Sora', fontSize: 14,
                                                         color: textSecondary, height: 1.6),
                               bodyMedium:     TextStyle(fontFamily: 'Sora', fontSize: 13,
                                                         color: textSecondary, height: 1.5),
                               labelLarge:     TextStyle(fontFamily: 'Sora', fontSize: 13,
                                                         fontWeight: FontWeight.w600, color: textPrimary, letterSpacing: 0.2),
                               labelMedium:    TextStyle(fontFamily: 'Sora', fontSize: 11,
                                                         fontWeight: FontWeight.w500, color: textSecondary, letterSpacing: 0.5),
    ),
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        ...
        foregroundColor: Colors.white,
          ...
          textStyle: const TextStyle(fontFamily: 'Sora', fontSize: 14,
    ...
    // FIX: CardThemeData zamiast CardTheme (Flutter 3.x)
