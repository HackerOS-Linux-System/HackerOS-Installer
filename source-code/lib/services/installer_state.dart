...
class InstallerState {
  ...
  final String           installerLanguage;   // kod języka UI instalatora
  // Locale/TZ/KB docelowego systemu (ustawiany przez użytkownika w kroku locale)
...
class InstallerNotifier extends StateNotifier<InstallerState> {
  ...
  state = state.copyWith(networkConnected: v, connectedSsid: ssid, connectedInterface: iface);
...
InstallerStep(id: 'done',     icon: '🎉', titles: {
